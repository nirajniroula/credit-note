...
public class RisingNumberView extends TextView implements RisingNumberBase {
    ...
    public RisingNumberView(Context context, AttributeSet attr){
        super(context,attr);
    }

    public RisingNumberView(Context context, AttributeSet attr, int defStyle)
    {
